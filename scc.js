...
const WEAPON_OPTIONS = [
    ...
    ["Physical/Magical Defense (Enhancement Level)", 0.8, 1.5, true, 0.1],
    ["Deals continuous damage by n% of damage dealt for 3 seconds", 5, 12, false, 1],
    ...
    ["Physical/Magical Defense", 6, 13, false, 1],
    ["Damage Reduction", 8, 15, false, 1],
    ["Damage to Boss Monsters", 8, 15, false, 1],
    ["Damage Taken from Boss Monsters", 8, 15, false, 1],
    ["Tenacity Skill Damage", 6, 13, false, 1],
    ["Strength Skill Damage", 6, 13, false, 1],
    ["Bravery Skill Damage", 6, 13, false, 1],
    ["All Skill Damage", 6, 13, false, 1],
    ["Action Speed", 8, 15, false, 1]
];
